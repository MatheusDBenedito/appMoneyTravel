...
const WalletCard: React.FC<WalletCardProps> = ({ wallet, balance }) => {
    ...
    return (
        <div className={clsx(
            ...
            isMe ? "bg-blue-50/50 border-blue-100 dark:bg-blue-900/20 dark:border-blue-800" : "bg-pink-50/50 border-pink-100 dark:bg-green-900/20 dark:border-green-800"
        )}>
            <div className="flex items-center gap-3 mb-3">
                <div className={clsx(
                    "w-12 h-12 rounded-full flex items-center justify-center overflow-hidden border-2",
                    isMe ? "bg-blue-100 text-blue-600 border-blue-200" : "bg-pink-100 text-pink-600 border-pink-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-700",
